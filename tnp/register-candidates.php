...
<body class="hold-transition skin-green sidebar-mini">
  ...
  <div class="wrapper">
          ...
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="enrollment" name="enrollment" placeholder="enrollment *" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" type="date" id="dob" min="2000-01-01" max="2050-01-31" name="dob" placeholder="Date Of Birth">
                </div>
                <div class="form-group">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      ...
      <strong>Copyright &copy; 2022 <a href="https://github.com/vikash9669" target="_blank">Placement Portal Developed By Vikash Kushwaha</a>.</strong> All rights
        reserved.
      </div>
    </footer>
